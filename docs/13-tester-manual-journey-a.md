...
| สิ่งที่ต้องมี | ขอได้จากไหน | ตัวอย่างบนเครื่องทดสอบ |
| --- | --- | --- |
...
| `organizationId` | ไม่บังคับ | ผูกกับหน่วยงานที่สร้างไว้ในข้อ 1 · **ถ้าไม่ส่งมา** ระบบจะสร้างหน่วยงานเปล่าชื่อ "หน่วยงานใหม่" พร้อมคำขอฉบับร่างรอไว้ให้แทน |

> ระบบ **ตั้งใจไม่คืนตัว token กลับมาใน API** ลิงก์เปิดใช้งานจะอยู่ในอีเมลเท่านั้น
> ถ้าเชิญอีเมลเดิมซ้ำ คำเชิญใบเก่าจะถูกยกเลิกอัตโนมัติ เหลือใช้ได้ทีละใบเสมอ
...
| `409` | `exists` | อีเมลนี้มีบัญชีในระบบอยู่แล้ว |
...
**ถ้าเครื่องส่งอีเมลจริง** ผู้ถูกเชิญเปิดอีเมลแล้วกดปุ่มในอีเมลได้เลย ไม่ต้องทำอะไรเพิ่ม

**ถ้าเป็นเครื่องทดสอบที่ไม่ส่งอีเมลจริง** ผู้ดูแลระบบต้องไปดึงลิงก์จากบันทึกการทำงานให้
...
จะได้บรรทัดหน้าตาแบบนี้ ส่งลิงก์นี้ให้ผู้ถูกเชิญ
...
ทดสอบผ่านข้อไหนแล้วติ๊กข้อนั้น
