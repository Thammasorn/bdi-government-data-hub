...
คู่มือชุดนี้ทำไว้ให้ **ผู้ทดสอบระบบ** ที่ยังไม่เคยเห็นระบบกลางเพื่อการแบ่งปันข้อมูลดิจิทัล (D2) มาก่อน
...
ระบบกลางเพื่อการแบ่งปันข้อมูลดิจิทัล (D2) เป็นระบบกลางที่ให้ **หน่วยงานภาครัฐ** เข้ามาลงทะเบียนหน่วยงานของตัวเอง
...
| --- | --- | --- |
| **ผู้ประสานงานของหน่วยงาน** | กรอกแบบฟอร์มลงทะเบียนหน่วยงาน และกรอกคำขอลงทะเบียนชุดข้อมูล | หน่วยงานของคุณ |
| **ผู้มีอำนาจกระทำการแทน** | ตรวจเอกสารแล้วกด "เห็นชอบและลงนาม" ในนามหน่วยงาน | หน่วยงานของคุณ |
| **ผู้ประสานงานของ BDI** | ตรวจความถูกต้อง แล้วส่งกลับให้แก้หรือส่งต่อไปด่านถัดไป | BDI |
...
| อีเมล | บทบาท |
| --- | --- |
| `officer@bdi.or.th` | ผู้ประสานงานของ BDI — เห็นและตรวจได้ทุกคำขอในระบบ |
...
| ต่อ (เลขต่อ) | ช่องแยกข้างเบอร์ ตัวเลขล้วนไม่เกิน 10 หลัก · ไม่มีเลขต่อให้เว้นว่าง · อย่าพิมพ์ "ต่อ" หรือขีดลงไป | `1232` |
...
| ชื่อชุดข้อมูล | ช่องภาษาไทยต้องมีอักษรไทย ช่องภาษาอังกฤษต้องมีอักษรอังกฤษ (ปนกันได้ แต่ห้ามไม่มีเลย) | `สถิติผู้ป่วยนอกรายเดือน` · `Monthly Outpatient Statistics` |
| อีเมลหน่วยงาน | ต้องไม่ซ้ำกับอีเมลผู้มีอำนาจกระทำการแทน | `contact@nso.go.th` |
| รหัสหน่วยงาน | **แก้ไม่ได้** ระบบกำหนดให้ — ผิดต้องแจ้งผู้ประสานงานของ BDI | `ORG-2026-0001` |
