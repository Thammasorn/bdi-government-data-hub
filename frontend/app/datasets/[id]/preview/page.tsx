...
export default function DatasetPreviewPage() {
  ...
  // ผูกกับ id ของคำขอที่โหลดมาแล้ว ไม่ใช่พารามิเตอร์บน URL
  const {
    documents,
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
      ...
      <div className="flex flex-col gap-6">
        {/*
          การ์ดเดียวกับที่หน้าตรวจสอบของเส้นทางจดทะเบียนหน่วยงานใช้ (BDI ขอเมื่อ
          2026-09-11 ว่าให้ทั้งสองเส้นทางหน้าตาเหมือนกัน และให้ "มีปุ่ม preview เอกสาร
          ได้เลย" อยู่บนหน้านี้) — เดิมหน้านี้ฝังตัวอ่าน PDF ของแบบฟอร์มไว้ตรง ๆ ซึ่งอ่าน
          ได้ฉบับเดียวและไม่เหมือนอีกเส้นทางหนึ่ง
        */}
        <LegalDocumentsCard
          documents={documents}
          description={datasetTitle(request)}
          error={documentsError}
          onRetry={reloadDocuments}
          regenerateLabel="ตรวจสอบคำขอ"
        />
