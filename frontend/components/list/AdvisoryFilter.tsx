 ...
 *
 * ชิปเรียงตามลำดับที่คำขอเดินจริง — ยังไม่มีผู้เชี่ยวชาญ → มอบหมายแล้วแต่ยังไม่มีความเห็น →
 * มีความเห็นแล้ว — และตั้งชื่อด้วยสิ่งที่ *มี/ไม่มี* ไม่ใช่ด้วยการกระทำ ("ยังไม่ได้ขอ", "รอ")
 * ซึ่ง BDI อ่านแล้วไม่แน่ใจว่าใครเป็นคนต้องทำ (การ์ด "ปรับชื่อตัวกรองคำขอเพิ่มข้อมูล" 2026-09-18)
 * ค่าใน URL (`with` / `awaiting` / `none`) ไม่เปลี่ยน — ลิงก์จากการ์ดหน้าแรกชี้มาด้วยค่าพวกนี้
 */
const OPTIONS: { value: AdvisoryFilterValue | null; label: string; dot: string | null }[] = [
  { value: null, label: "ทั้งหมด", dot: null },
  { value: "none", label: "ยังไม่มีผู้เชี่ยวชาญ", dot: null },
  { value: "awaiting", label: "ยังไม่มีความเห็น", dot: "border border-navy-300" },
 ...
 *
 * คำบนป้ายเป็นคำเดียวกับชิปตัวกรองที่เลือกมันได้ (`OPTIONS` ข้างบน) — ป้ายในแถวกับตัวกรอง
 * เรียกสภาพเดียวกันคนละชื่อคือสิ่งที่ผู้อ่านเอามาเทียบกันแล้วงง
 *
