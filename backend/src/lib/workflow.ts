 ...
 * ผู้ประสานงานของ BDI ถูกยกเลิกเมื่อ 2026-08-30 หน่วยงานลงนามแล้วไปที่ BDI_FINAL_APPROVAL ตรง ๆ
 */
import {
  AssignmentSource,
  CommentVisibility,
 ...
 * ด่านของผู้ประสานงานของ BDI ตลอด และตัวการมอบหมายเป็นคอลัมน์บนคำขอ แต่ไทม์ไลน์บนหน้าจอ
