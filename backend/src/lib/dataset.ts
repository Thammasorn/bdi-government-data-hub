...
export const datasetSubmitSchema = z
  .object({
    ...
    title: required("กรุณากรอกชื่อชุดข้อมูลภาษาไทย")
      ...
      .refine(containsThai, "ชื่อชุดข้อมูลภาษาไทยต้องมีอักษรไทย (มีภาษาอังกฤษปนได้ เช่น สถิติผู้ป่วยนอกรายเดือน (OPD))"),
    name: required("กรุณากรอกชื่อชุดข้อมูลภาษาอังกฤษ")
      .max(150, "ชื่อชุดข้อมูลต้องยาวไม่เกิน 150 ตัวอักษร")
      .refine(
        containsEnglish,
        "ชื่อชุดข้อมูลภาษาอังกฤษต้องมีอักษรภาษาอังกฤษ (มีตัวเลขและอักษรไทยปนได้ เช่น Monthly Outpatient Statistics)",
      ),
    dataFields: required("กรุณาระบุรายการข้อมูล (ฟิลด์ข้อมูล) อย่างน้อย 1 ฟิลด์").max(
      1000,
      "รายการข้อมูลรวมกันต้องยาวไม่เกิน 1,000 ตัวอักษร",
    ),
