...
export const TEMPLATE_VARIABLES = {
  ...
  "dataset.tags": { scope: "dataset", group: "dataset", description: "คำสำคัญหรือคำค้น คั่นด้วยจุลภาค", example: "น้ำฝน, อุทกภัย" },
  "dataset.notes": { scope: "dataset", group: "dataset", description: "รายละเอียดชุดข้อมูล", example: "ข้อมูลปริมาณน้ำฝนรายวันจากสถานีตรวจวัด" },
  "dataset.objective": { scope: "dataset", group: "dataset", description: "วัตถุประสงค์ที่เลือก (ข้อ 8 เลือกได้หลายข้อ) เป็นป้ายคั่นด้วยจุลภาค — ข้อที่เลือกยังพิมพ์ ✔ ผ่าน {{tick.objective.<รหัส>}} ด้วย", example: "ยุทธศาสตร์ชาติ, เพื่อการให้บริการประชาชน" },
  "dataset.objectiveOther": { scope: "dataset", group: "dataset", description: "วัตถุประสงค์อื่น ๆ ที่ระบุเอง — ว่างถ้าไม่ได้เลือก \"อื่น ๆ\"", example: "โครงการนำร่องเมืองอัจฉริยะ" },
