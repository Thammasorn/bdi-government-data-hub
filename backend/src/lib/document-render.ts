...
export const TEMPLATE_VARIABLES = {
  ...
  "dataset.objective": { scope: "dataset", group: "dataset", description: "วัตถุประสงค์ที่เลือก (ข้อ 8 เลือกได้หลายข้อ) เป็นป้ายคั่นด้วยจุดกลาง — ข้อที่เลือกยังพิมพ์ ✔ ผ่าน {{tick.objective.<รหัส>}} ด้วย", example: "ยุทธศาสตร์ชาติ · เพื่อการให้บริการประชาชน" },
